...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "$BUILT_PRODUCTS_DIR/JSSAlertView-iOS10.1/JSSAlertView.framework"
  install_framework "$BUILT_PRODUCTS_DIR/PhoneNumberKit-iOS10.1/PhoneNumberKit.framework"
